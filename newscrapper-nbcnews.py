...
def get_article_urls(base_url):
    ...
    article_links = [a['href'] for h2 in soup.find_all('h2', class_=['storyline__headline founders-cond fw6 large headlineOnly', 'related-content-tease__headline']) for a in h2.find_all('a')]
